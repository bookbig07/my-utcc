                ...
                <div>
                    ...
                    <ul className="mt-6 space-y-2 tracking-wide">
                        <li className="min-w-max">
                            <div onClick={() => Manage()} className="relative flex items-center space-x-4 px-4 py-3 text-gray-900 cursor-pointer hover:bg-slate-100 transition duration-300 ease-in-out">
                                <IoDocumentText className="-ml-1 h-6 w-6"/>
                                <span className="-mr-1 font-medium">Manage</span>
                            </div>
                        </li>
                        <li className="min-w-max">
                            <div onClick={() => Logout()} className="relative flex items-center space-x-4 px-4 py-3 text-gray-900 cursor-pointer hover:bg-slate-100 transition duration-300 ease-in-out">
